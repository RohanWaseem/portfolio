  ...
  return (
    <div>
      ...
      <div className='fixed flex  justify-between w-full text-black sm:pl-5  md:pl-10 md:pr-10 sm:pr-2 pl-10   pr-10 border-b-1 border-sky-400  items-center h-18 bg-slate-950'>
        <div>
          <h1 className='text-3xl font-black text-sky-400'>Rohan Waseem</h1>
        </div>
...
<div className='pl-10 pr-10 flex  gap-5  items-center justify-center  flex-wrap'>
    ...
    <div className='bg-slate-900 flex flex-col lg:h-90 hover:border-cyan-400 z-50  hover:border-2 transition-transform duration-300 hover:-translate-y-1 rounded-2xl justify-center  items-center h-50 mt-10 sm:w-[46%] sm:h-70 lg:w-[30%]'>
    <div>
